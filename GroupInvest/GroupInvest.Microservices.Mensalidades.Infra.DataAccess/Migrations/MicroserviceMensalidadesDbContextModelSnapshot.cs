...
namespace GroupInvest.Microservices.Mensalidades.Infra.DataAccess.Migrations
{
    ...
    partial class MicroserviceMensalidadesDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GroupInvest.Microservices.Mensalidades.Domain.Entidades.DistribuicaoCotas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int>("NumeroTotalCotas")
                        .HasColumnType("int");
                    ...
                    b.ToTable("DistribuicaoCotas");
                });

            modelBuilder.Entity("GroupInvest.Microservices.Mensalidades.Domain.Entidades.DistribuicaoParticipante", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int?>("DistribuicaoCotasId")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("ValorDistribuicao")
                        .HasColumnType("decimal(65,30)");
                    ...
                    b.HasIndex("DistribuicaoCotasId");

                    b.HasIndex("ParticipanteId");

                    b.ToTable("DistribuicaoParticipante");
                });
            ...
            modelBuilder.Entity("GroupInvest.Microservices.Mensalidades.Domain.Entidades.DistribuicaoParticipante", b =>
                {
                    b.HasOne("GroupInvest.Microservices.Mensalidades.Domain.Entidades.DistribuicaoCotas", "DistribuicaoCotas")
                        .WithMany()
                        .HasForeignKey("DistribuicaoCotasId");
