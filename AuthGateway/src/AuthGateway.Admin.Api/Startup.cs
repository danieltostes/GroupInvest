...
using AuthGateway.Admin.Api.Configuration;
using AuthGateway.Admin.Api.Configuration.Authorization;
using AuthGateway.Admin.Api.ExceptionHandling;
using AuthGateway.Admin.Api.Helpers;
using AuthGateway.Admin.Api.Mappers;
using AuthGateway.Admin.Api.Resources;
using AuthGateway.Admin.EntityFramework.Shared.DbContexts;
using AuthGateway.Admin.EntityFramework.Shared.Entities.Identity;
using Skoruba.IdentityServer4.Shared.Configuration.Helpers;
using AuthGateway.Shared.Dtos;
using AuthGateway.Shared.Dtos.Identity;

namespace AuthGateway.Admin.Api
{
