...
using AuthGateway.STS.Identity.Configuration;
using AuthGateway.STS.Identity.Configuration.ApplicationParts;
using AuthGateway.STS.Identity.Configuration.Constants;
using AuthGateway.STS.Identity.Configuration.Interfaces;
using AuthGateway.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace AuthGateway.STS.Identity.Helpers
{
